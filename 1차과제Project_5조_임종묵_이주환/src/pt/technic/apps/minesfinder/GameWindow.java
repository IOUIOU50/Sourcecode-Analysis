...
public class GameWindow extends javax.swing.JFrame {
    ...
    public GameWindow(Minefield minefield, SettingTable setting) {
...
//                                "Lost!", JOptionPane.INFORMATION_MESSAGE); //다시 할건지, 나갈건지 선택지 부여
    ...
    public GameWindow(Minefield minefield, RecordTable record, SettingTable setting) { 
        this.minefield = minefield;
        this.record = record;
        this.setting=setting;
        initComponents();
...
//                                "Lost!", JOptionPane.INFORMATION_MESSAGE); //다시 할건지, 나갈건지 선택지 부여
                        ...
                        long b = record.getScore(0);
                        boolean newRecord = minefield.getGameDuration() < record.getScore(0);
